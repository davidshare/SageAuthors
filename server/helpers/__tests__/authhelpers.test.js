...
describe('Test for auth helpers', () => {
  ...
  it(
    '(encryptPassword) should throw an error if password is null ' +
  ...
  it(
    '(comparePasswords) should throw an error if password ' +
  ...
  it(
    '(generateJWT) should throw an error if  ' +
  ...
  it(
    '(stripDate) should throw an error if  ' +
      'the supplied user object is invalid',
    done => {
